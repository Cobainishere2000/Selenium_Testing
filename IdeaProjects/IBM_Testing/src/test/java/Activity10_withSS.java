...
public class Activity10_withSS {
    ...
    public void setup() {
        ...
        //to execute testcases without browser pop up add the following
        //two lines and pass the firefoxOptions object to the driver
        //FirefoxOptions firefoxOptions= new FirefoxOptions();
        //firefoxOptions.setHeadless(true);
        //driver = new FirefoxDriver(firefoxDriver);
        //read more about this on driver capabilities options
    ...
    public static Object[][] signUpInfo() {
        String filePath = "C:\\Users\\SaptarshiPal\\IdeaProjects\\IBM_Testing\\src\\test\\java\\Activity10.xlsx";
    ...
    public void registrationTest(List<Object> rows) throws AWTException, IOException {
        ...
        //take ss
        String fileName = System.currentTimeMillis() + "FormFill";
       ...
       String fileName_2 = System.currentTimeMillis() + "_popup";
